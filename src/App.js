...
class App extends React.Component {
  ...
  handleSubmit(e){
    ...
    let url = 'https://dj-react-to-do-app.herokuapp.com/api/task-create/';
  ...
  deleteItem(task){
    ...
    fetch(`https://dj-react-to-do-app.herokuapp.com/api/task-delete/${task.id}/`, {
      method:'DELETE',
      headers:{
        'Content-type':'application/json',
        'X-CSRFToken':csrftoken,
  ...
  strikeUnstrike(task){
    ...
    const csrftoken = this.getCookie('csrftoken');
    const url = `https://dj-react-to-do-app.herokuapp.com/api/task-update/${task.id}/`;
